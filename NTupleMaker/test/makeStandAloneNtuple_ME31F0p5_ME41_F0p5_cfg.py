...
## #options.inputFiles = "file:GEM2019Upg14_CFEBBufferOverload_0p51.root"
...
mylist = FileUtils.loadListFromFile ('rereco_me31f0p5_me41_0p5.list') 
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string('ME31F0p5_ME41_F0p5.root'),
                                   )
