...
## #options.inputFiles = "file:GEM2019Upg14_CFEBBufferOverload_0p751.root"
...
mylist = FileUtils.loadListFromFile ('rereco_me31f0p75_me41_0p75.list') 
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string('ME31F0p75_ME41_F0p75.root'),
                                   )
