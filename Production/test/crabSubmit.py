...
config.JobType.psetName = 'run_rereco_and_ntupler_cfg.py'

input_fr21 = 'failRateME21=%.2f' % (failRateME21)
input_fr31 = 'failRateME31=%.2f' % (failRateME31)
input_fr41 = 'failRateME41=%.2f' % (failRateME41)

config.JobType.pyCfgParams = ['outputFile=rereco_fail.root', input_fr21, input_fr31, input_fr41] # fail rates set above, now passed to config params
...
config.Site.whitelist = ['T2_US_UCSD', 'T2_BR_SPRACE']
